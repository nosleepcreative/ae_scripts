function arrangeSelectedItemsInNewComp() {
    ...
    // Add items to the new composition and position them in a line (horizontal or vertical)
    ...
    for (var i = 0; i < selectedItems.length; i++) {
        ...
        // Calculate position and layout in a line
        var position;
        if (isHorizontal) {
        ...
        var textPosition = isHorizontal ?
            [position[0], position[1] + item.height / 2 + 20] :
            [position[0], position[1] + item.height / 2 + 20];  // Adjust the offset as needed
