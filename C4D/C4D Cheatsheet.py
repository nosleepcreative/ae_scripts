# Imports the core Cinema 4D API for scripting with general tools and classes
# Imports the MoGraph module (alias: mo), giving access to motion graphics tools like cloners and effectors
